...
export default class LDAPLogInModal extends Modal {
  ...
  fields() {
    ...
    items.add('identification', <div className="Form-group">
      <input className="FormControl" name="identification" type="text" placeholder={extractText(app.translator.trans(translationPrefix + 'email_placeholder'))}
  ...
  onsubmit(e) {
    ...
    const height = 400;
    const $window = $(window);
    const url = app.forum.attribute('baseUrl') + '/auth/with';
    const name = "ldapauth";
